...
class RestPercepton_block_v1(nn.Module):
    """
...
class ImageClassifierNetwork_v1(nn.Module):
...
class RestGoogleNet_Clasificator_biniary(ImageClassifierNetwork_v1):
    """
    ...
    def __init__(self, in_channels):
        ...
        self.Intercepton1 = RestPercepton_block_v1(in_channels=32, out_channels=144, conv_size_in=[32,32], conv_size_out=[16, 48, 48],change_depth_pool=False)
        self.Intercepton2 = RestPercepton_block_v1(in_channels=144, out_channels=208, conv_size_in=[64,64], conv_size_out=[24, 72, 64],change_depth_pool= 48)
        self.Intercepton3 = RestPercepton_block_v1(in_channels=208, out_channels=232, conv_size_in=[96,96], conv_size_out=[32, 96, 72],change_depth_pool=32)
        self.Intercepton4 = RestPercepton_block_v1(in_channels=232, out_channels=288, conv_size_in=[128,128], conv_size_out=[48, 128, 96],change_depth_pool=16)
